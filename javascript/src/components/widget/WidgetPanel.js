/**
 * @class Ozone.components.widget.WidgetPanel
 * @mixes Ozone.components.widget.WidgetBase
...
/**
 * @typedef {object} WidgetPanelState
 * @property {string} universalName
 * @property {string} widgetGuid
 * @property {string} uniqueId
 * @property {string} dashboardGuid
 * @property {string} paneGuid
 * @property intentConfig
 * @property launchData
 ...
 * @property {number} columnPos
 * @property buttonId
 * @property {boolean} buttonOpened
 * @property {string} region
 * @property {number} statePosition
 * @property {boolean} singleton
 * @property {boolean} floatingWidget
 */

/**
 * @class Ozone.components.pane.Pane
...
Ext.define('Ozone.components.pane.Pane', {
     ...
     *
     * @param {WidgetPanelState | WidgetPanelState[]} models
     * @param {number} x
     * @param {number} y
     * @param {number} launchPosition
     * @returns {*}
     */
    ...
    cloneWidgetDataForTransfer: function (widget) {
        ...
        var widgetDefinitionModel = this.dashboard.widgetStore.findRecord('widgetGuid', widget.model.get('widgetGuid'));
    ...
    reorderWidget: function (widget, newPosition, oldPosition) {
        var me = this;
        var widgetStateModelData = me.cloneWidgetDataForTransfer(widget);

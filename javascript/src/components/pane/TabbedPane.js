/**
 * @class Ozone.components.pane.TabbedPane
 * @extends Ozone.components.pane.Pane
 *
 * @property {Ozone.components.tab.WidgetTabPanel} tabPanel
 */
Ext.define('Ozone.components.pane.TabbedPane', {
    ...
    moveWidgetRight: function (widget) {
        var widgetIndex = this.findWidgetIndex(widget);
        var lastWidgetIndex = this.tabPanel.items.getCount() - 1;
    ...
    findWidgetIndex: function (widget) {
        return this.tabPanel.items.keys.lastIndexOf(widget.id);
    },
    ...
    reorderWidget: function (widget, newPosition, oldPosition) {
        ...
        this.tabPanel.move(oldPosition, newPosition);
        this.tabPanel.tabBar.move(oldPosition, newPosition);
    }
